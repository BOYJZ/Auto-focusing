...
def gradient_ascent(noise,x, y, z, mu_x, mu_y, mu_z, sigma_x, sigma_y, sigma_z,SNR=1, learning_rate=0.01, max_iter=1000, step_size = 0.04,aim_value=0.98,stop_steps=0.001):
  if noise==0:
