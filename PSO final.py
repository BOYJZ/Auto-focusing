...
num_iterations = 20  # number of iterations to run the PSO
learning_rate = 0.1  # learning rate for the PSO
c1 = 2  # cognitive parameter
c2 = 2  # social parameter
robust_number = 10  # number of best positions to average for the robust maximum
...
# Plot the success rate vs SNR
# plt.plot(SNR_values, success_rates, marker='o')
# plt.xlabel('SNR')
# plt.ylabel('Success Rate')
# plt.title('Success Rate vs SNR for PSO on Noisy Gaussian')
# plt.grid(True)
# plt.show()
